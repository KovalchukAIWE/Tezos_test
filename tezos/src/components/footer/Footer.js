        ...
        <div className={styles.footer_wrapper}>
            ...
            <div className={styles.footer_items}>
                <ul className={styles.first_block}>
                    <li className={styles.list}><a href='#skils'  className={styles.list_items}>Testing skils</a></li>
                    <li className={styles.list}><a href='#description'  className={styles.list_items}>General description of the assignment</a></li>
                    <li className={styles.list}><a href='#team'  className={styles.list_items}>Our team</a></li>
                </ul>
